...
#原来是PRETAINED_WEIGHT_PATH ='NETWORK/xception-b5690688.pth'
PRETAINED_WEIGHT_PATH = 'C:/Users/91698/.cache/torch/hub/checkpoints/xception-b5690688.pth'
...
def xception(num_classes=1000, pretrained='imagenet', inc=3):
    ...
    if pretrained:
        ...
        ssl._create_default_https_context = ssl._create_unverified_context#ssl过期
         # ,strict=False#model.load_state_dict()#,strict=False
        model_zoo.load_url(settings['url'])
