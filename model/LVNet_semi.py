...
class Two_Stream_Net(nn.Module):
    def __init__(self):
        ...
        self.msff = EMFF(in_channels=self.mid_channel, 
                         size=self.seg_size)
        self.HBFusion = HdmProdBilinearFusion(dim1=(64+128+256+728+728), dim2=2048, hidden_dim=2048, output_dim=self.output_dim)

        self.cfie0 = CFIE(in_channel=64)
        self.cfie1 = CFIE(in_channel=128)
        self.cfie2 = CFIE(in_channel=256)


        self.lfe0 = EFG(in_channel=728)
        self.lfe1 = EFG(in_channel=728)
        self.lfe2 = EFG(in_channel=728)
        ...
        seg_in_channels = self.mid_channel * 6  # 512 * 6 = 3072
